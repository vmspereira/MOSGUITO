"""
Django settings for mosguito project.
...
SECRET_KEY = 'django-insecure-)1&9&9%rr86^%81ok#n(pu_jiwi$4d^4oyi^#eu)m$or618#s4'
...
WSGI_APPLICATION = 'mosguito.wsgi.application'
